...
**BitTorrent** giải quyết bằng ý tưởng: _"người tải cũng là người cho tải"_.
...
Tracker **không** truyền file. Nó chỉ trả lời câu hỏi _"ai đang ở trong swarm
của file X?"_. Peer mới hỏi tracker → nhận danh sách peer → tự kết nối trực tiếp
...
chia sẻ** (`sharedFiles`) — nhưng file B _vừa tải về_ từ A **không** tự động được
...
- **scaling** (1 seed + 8 leech): tải từ **8 nguồn**, xong ~1.2s — _càng đông càng nhanh_.
